---
description: Automated security hygiene audit — checks headers, CORS, cookies, auth, SRI, XSS surface, and dependencies
---
...
Runs 9 checks in sequence. Stops on failure and tells you exactly what broke.
